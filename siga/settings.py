...
SECRET_KEY = 'django-insecure-)2j@h@%t^f42+$6b*vych0@t8&@yx#ni0xgd%bn-inxmwir2_c'
...
FIREBASE_PRIVATE_KEY_ID = get_env_variable('FIREBASE_PRIVATE_KEY_ID')
FIREBASE_PRIVATE_KEY = get_env_variable('FIREBASE_PRIVATE_KEY')
FIREBASE_CLIENT_EMAIL = get_env_variable('FIREBASE_CLIENT_EMAIL')
FIREBASE_CLIENT_ID = get_env_variable('FIREBASE_CLIENT_ID')
FIREBASE_CLIENT_CERT_URL = get_env_variable('FIREBASE_CLIENT_CERT_URL')